...
var DirectoryComponent = (function () {
    ...
    function DirectoryComponent(data, route, router, alphabet) {
        ...
        this.azList = this.groups$
            ...
            .map(function (grp) { return _this.alphabet.map(function (letr) { return Object.assign(new __WEBPACK_IMPORTED_MODULE_4_app_entities_az_letter__["a" /* AZLetter */](), {
            Letter: letr,
...
//# sourceMappingURL=az-letter.js.map
